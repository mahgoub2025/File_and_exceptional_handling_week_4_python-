...
This module allows users to read, write, append, and extract data
from different file types (text, Excel, PDF, and images).
It demonstrates file handling and error handling in Python.
"""
...
def handle_image_file(filename):
    ...
    try:
        ...
        """
    Read a text file and print its content. Handles FileNotFoundError.
    Parameters:
